...
import { DONATION_TIERS, DonationTier, PAYMENT_METHODS } from "@/types";
...
const paymentMethods: PAYMENT_METHODS[] = ["AIRTEL", "MTN", "FLUTTERWAVE"];

const Donate = () => {
    const [selectedTier, setSelectedTier] = useState<DonationTier | null>(null);
    const [customAmount, setCustomAmount] = useState(0);
    const [paymentMethod, setPaymentMethod] = useState<PAYMENT_METHODS>("MTN");
    ...
    const handleSubmit = async (e: FormEvent) => {
        ...
        if (
            ...
            !validatePhoneNumber(donorInfo.phone)
        ) {
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="relative">
                                        ...
                                        <input
                                            ...
                                            className="w-full h-12 pl-16 pr-4 rounded-lg border-gray-300 dark:border-gray-700 dark:bg-dark-bg dark:text-white shadow-xs focus:border-rotaract-blue focus:ring-rotaract-blue dark:focus:border-dark-primary dark:focus:ring-dark-primary text-base"
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full h-12 px-4 rounded-lg border-gray-300 dark:border-gray-700 dark:bg-dark-bg dark:text-white shadow-xs focus:border-rotaract-blue focus:ring-rotaract-blue dark:focus:border-dark-primary dark:focus:ring-dark-primary text-base"
                                ...
                                <div>
                                    ...
                                    <textarea
                                        ...
                                        rows={4}
                                        className="w-full px-4 py-3 rounded-lg border-gray-300 dark:border-gray-700 dark:bg-dark-bg dark:text-white shadow-xs focus:border-rotaract-blue focus:ring-rotaract-blue dark:focus:border-dark-primary dark:focus:ring-dark-primary text-base"
