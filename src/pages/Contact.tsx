        ...
        <PageTransition>
            ...
            <div className="bg-gray-50 dark:bg-dark-bg transition-colors">
                ...
                <motion.div
                    initial={{ opacity: 0 }}
                    animate={{ opacity: 1 }}
                    className="relative bg-linear-to-br from-rotaract-navy to-rotaract-blue dark:from-dark-surface dark:to-dark-bg text-white py-20"
                >
                    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                        ...
                        <p className="text-xl max-w-3xl mx-auto">
                            Have questions about our campaign? We'd love to hear
                            from you.
                        </p>
                    </div>
                </motion.div>
