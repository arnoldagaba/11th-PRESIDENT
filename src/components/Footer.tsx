                    ...
                    <motion.div variants={itemVariants} className="space-y-4">
                        ...
                        <div className="pt-4">
                            <p className="text-sm text-gray-400 dark:text-gray-500">
                                &copy; {currentYear} Rotaract Campaign.
                                <br />
                                All rights reserved.
                            </p>
                        </div>
                                    ...
                                    >
                                        {"external" in link ? (
                                            <a
                                                ...
                                                className="text-gray-300 hover:text-rotaract-gold-light dark:text-dark-text-secondary dark:hover:text-dark-primary-light transition-colors flex items-center"
                                            >
                                                {link.name}
                                                <svg
                                            ...
                                            <Link
                                                to={link.href}
                                                className="text-gray-300 hover:text-rotaract-gold-light dark:text-dark-text-secondary dark:hover:text-dark-primary-light transition-colors"
                                            >
                                                {link.name}
                                            </Link>
                                        )}
